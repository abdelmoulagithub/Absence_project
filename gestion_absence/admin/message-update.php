...
echo 2;
            header("Location: messages.php?success=Statut changé en $new_statut");
            exit;
        } else {
            header("Location: messages.php?error=Message introuvable");
            exit;
        }
        echo 3;

    } else {
        header("Location: messages.php?error=Code message manquant");
        exit;
    }
echo 4;
} else {
